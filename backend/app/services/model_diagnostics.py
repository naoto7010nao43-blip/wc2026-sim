...
(Spec 012), and manager_tactical_data_audit_*.json (Spec 013) reports
produced by their respective build scripts. Never computes or mutates
anything itself -- if a report is missing, returns a calm empty state
rather than failing.
"""
